  ...
  <div class="about">
         <div class="container_width">
            <div class="row d_flex grig">
               <div class="col-sub">
                  <div class="about_img">
                     <figure><img :src="image" :alt="breed" />
                     </figure>
                  </div>
               </div>
               <div class="col-sub order">
                  <div class="titlepage text_align_left">
                    <h2>{{ breed }}</h2>
                     <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minima nesciunt numquam beatae perspiciatis maxime libero aliquid iste doloremque illo voluptates.</p>
                  </div>
               </div>
            </div>
         </div>
